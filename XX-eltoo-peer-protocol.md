...
can be redeemed, if need be. It is sent in response to `funding_created`.
...
pre-sharing of nonces to complete a 2-round MuSig2 signature. This allows a healthy
