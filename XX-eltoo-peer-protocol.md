...
A sending node:
  ...
  - MUST include a tlv for `partial_sig`:
    - The partial signature must be generated by using the combined public nonces exchanged last exchanged by `shutdown` messages or `closing_signed_eltoo` messages, and the private nonce generated
